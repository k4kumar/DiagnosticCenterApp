<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnpaidBillReportUI.aspx.cs" Inherits="ProjectApp.UI.UnpaidBillReportUI" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    padding:2px 6px;
        ...
        #unpaidBillGridView tr th, #unpaidBillGridView tr td {
             text-align: center;
    font-size: 1.2em;
    padding: 6px;
        }
        ...
        <table width="80%">
            <tr>
                ...
                <td style="padding-left: 20px; font-size: 1.3em;text-align: right;">
                  <asp:TextBox ID="fromDateTextBox" runat="server" required="required" ToolTip="YYYY-MM-DD"></asp:TextBox>
                </td>
            </tr>
			...
			<tr>
                ...
                <td style="padding-left: 20px; font-size: 1.3em;text-align: right;"><br/>
                   <asp:TextBox ID="toDateTextBox" runat="server" required="required" ToolTip="YYYY-MM-DD"></asp:TextBox>
                </td>
            </tr>
