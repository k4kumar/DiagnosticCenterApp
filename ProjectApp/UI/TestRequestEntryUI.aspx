    ...
    <div >
        ...
        <table width="80%">
			...
			<tr>
                ...
                <td style="padding-left: 20px; font-size: 1.3em;text-align: right;"><br/>
                   <asp:DropDownList ID="testSelectDropDownList"  CssClass="testSelectDropDownList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="testSelectDropDownList_SelectedIndexChanged">
                       </asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
			 ...
			 <tr>
               <td style="padding-left: 20px; font-size: 1.3em; text-align: right;">
                ...
                <td style="padding-left: 20px; font-size: 1.3em; text-align: right;">
                    <br/>
                    <asp:Button ID="clearButton" class="testrequestsavebutton" runat="server" Text="Clear" OnClick="clearButton_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
